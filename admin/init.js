...
function switchDbView(viewId, btn) {
  ['chinese-bank', 'word-image', 'english', 'radical', 'zhuyin', 'audio-chinese', 'math-bank', 'audio-math'].forEach(function(v) {
  ...
  if (viewId === 'radical')       loadRadicalTab();
  if (viewId === 'zhuyin')        loadZhuyinTab();
